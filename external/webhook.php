...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $data = json_decode($input, true);
        ...
        $query = "SELECT wslog.notification_id as notification_id , wslog.id as id
        ...
        $aberto_sql2 = "SELECT id, datapag, nossonum, recibo, valorpag, `login`, datapag, coletor,`status`, formapag from sis_lanc WHERE id = ".$id_lanc." and login = '".$login_cliente."' ";
        ...
        while ($fatura = $aberto_result2->fetch_assoc()) {
            ...
            $updateQuery = "UPDATE sis_lanc SET formapag = 'dinheiro', `status` = '".$statusName."', datapag = '".$datapagamento."', coletor = 'notificacao', recibo='".$idtransaction."', valorpag = ".$amountPaid."";
            if($amount_fees){
